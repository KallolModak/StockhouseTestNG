...
public class WebdriverUtility extends Sync{
	...
	public void safeClick(By locator, int... optionWaitTime)
	{
		...
		try
		{
			...
			{
//				log.error("Unable to click the element " + locator+getStackTrace());
//				Assert.fail("Unable to click the element " + locator+getStackTrace());
				try
				{
		...
		catch(StaleElementReferenceException e)
		{
			try
			{
				...
				}catch(Exception eee)
				{
					...
					Assert.fail("Element with " + locator + " is not attached to the page document"+getStackTrace());
				}
			}
		}
		catch (NoSuchElementException e)
		{
			...
			Assert.fail("Element " + locator + " was not found in DOM"+getStackTrace());
		}
		catch(Exception e)
		{
	...
	public void safeDblClick(By locator, int... optionWaitTime)
	{
		try
		{
			...
			{			
				log.error("Unable to double click the element " + locator+getStackTrace());
				Assert.fail("Unable to double click the element " + locator+getStackTrace());
			}
		}
		catch(StaleElementReferenceException e)
		{
	...
	public void safeClearAndType(By locator, String text, int... optionWaitTime)
	{
		try
		{
			...
			{			
				...
				Assert.fail("Unable to clear and enter " + text + " in field "+ locator+getStackTrace());
			}
		}
		catch(StaleElementReferenceException e)
		{
		...
		catch(Exception e)
		{
			...
			Assert.fail("Unable to clear and enter '" + text + "' text in field with locator -"+ locator+getStackTrace());
		}
	}
	...
	public void safeType(By locator, String text, int... optionWaitTime)
	{
		try
		{
			...
			else
			{
				...
				Assert.fail("Unable to enter " + text + " in field " + locator+getStackTrace());
			}
		}
		catch(StaleElementReferenceException e)
		{
		...
		catch(Exception e)
		{
			...
			Assert.fail("Unable to enter '" + text + "' text in field with locator -"+ locator+getStackTrace());
		}
	}
	...
	public void safeSelectRadioButton(By locator, int... optionWaitTime)
	{
		try
		{
			...
			{
				log.error("Unable to select Radio button "+locator+getStackTrace());
				Assert.fail("Unable to select Radio button "+locator+getStackTrace());
			}
		}
		catch(StaleElementReferenceException e)
		{
		...
		{
			log.error("Unable to click on radio button with locator '" + locator + "'' "+getStackTrace());		
			Assert.fail("Unable to click on radio button with locator '" + locator + "'' "+getStackTrace());	
		}	
	}
	...
	public void safeCheck(By locator, int... optionWaitTime)
	{
		try
		{
			...
			{			
				log.error("Unable to select checkbox " + locator+getStackTrace());
				Assert.fail("Unable to select checkbox " + locator+getStackTrace());
			}
		}
		catch(StaleElementReferenceException e)
		{
		...
		{
			log.error("Unable to check the checkbox with locator '" + locator + "'' "+getStackTrace());		
			Assert.fail("Unable to check the checkbox with locator '" + locator + "'' "+getStackTrace());	
		}	
	}
	...
	public void safeUnCheck(By locator, int... optionWaitTime)
	{
		try
		{
			...
			{			
				log.error("Unable to uncheck the checkbox " + locator+getStackTrace());
				Assert.fail("Unable to uncheck the checkbox " + locator+getStackTrace());
			}
		}
		catch(StaleElementReferenceException e)
		{
		...
		{
			log.error("Unable to uncheck the checkbox with locator '" + locator + "'' "+getStackTrace());		
			Assert.fail("Unable to uncheck the checkbox with locator '" + locator + "'' "+getStackTrace());	
		}	
	}
	...
	public void safeCheckByOption(By locator,boolean checkOption, int... optionWaitTime)
	{
		try
		{
			...
			{			
				log.error("Unable to Select or Deselect checkbox " + locator+getStackTrace());
				Assert.fail("Unable to Select or Deselect checkbox " + locator+getStackTrace());
			}
		}
		catch(StaleElementReferenceException e)
		{
		...
		{
			log.error("Unable to check or uncheck the checkbox with locator '" + locator + "'' "+getStackTrace());		
			Assert.fail("Unable to check or uncheck the checkbox with locator '" + locator + "'' "+getStackTrace());	
		}		
	}
	...
	public void safeSelectCheckboxes(int waitTime ,By... locator) throws Exception
	  {			
		...
		try
		{
			...
			{
				log.error("Expected atleast one locator as argument to safeSelectCheckboxes function"+getStackTrace());
				Assert.fail("Expected atleast one locator as argument to safeSelectCheckboxes function"+getStackTrace());
			}
		}
		catch(StaleElementReferenceException e)
		{
			log.error("Element with locator- " + check + " is not attached to the page document"+getStackTrace());
			Assert.fail("Element with locator- " + check + " is not attached to the page document"+getStackTrace());
		}
		catch (NoSuchElementException e)
		{
		...
		{
			log.error("Unable to select checkbox " + check+getStackTrace());	
			Assert.fail("Unable to select checkbox " + check+getStackTrace());
		}
	  }
	 ...
	 */
	 public WebElement getActivelocatorInSet(By locator) throws Exception
	 {
			 ...
			 for(int i = 0; i < elems.size(); i++)
			 {
				 if(elems.get(i).isDisplayed())
				 {
					 if(++activeElemCount>1)
						 log.error("More than 1 active visible locator found on page, expecting only 1"+ getStackTrace());
					 else
		 ...
		 {
			 log.error("Element not found - "+ locator +getStackTrace());
	...
	public void mouseHoverAndSelectOption(By locator,By byOptionlocator,int waitTime)
	{
		...
		{
			log.error("Element with " + locator + "or"+ byOptionlocator +"is not attached to the page document"+getStackTrace());
			Assert.fail("Element with " + locator + "or"+ byOptionlocator +"is not attached to the page document"+getStackTrace());
		}
		catch (NoSuchElementException e)
		{
			log.error("Element " + locator + "or"+ byOptionlocator + " was not found in DOM"+getStackTrace());	
			Assert.fail("Element "+ locator + "or"+ byOptionlocator +" was not found in DOM"+getStackTrace());
		}
		catch(Exception e)
		{
	...
	public void mouseHoverJScript(By locator,String Choice,int waitTime)
	{
		...
		{		    
			e.printStackTrace();
			log.error("Some exception occurred while hovering"+getStackTrace());
			Assert.fail("Some exception occurred while hovering"+getStackTrace());
		}
	}
	...
	public void safeClick(By locatorToClick,By locatorToCheck, int waitElementToClick,int waitElementToCheck ) throws Exception 
	{
        ...
        if (!bResult)
        {
        	Assert.fail("Unable to click on element " + locatorToClick+getStackTrace());
        }
	}
		...
		try
		  {
			...
			{
				log.error("Element with " + Sourcelocator + "or"+ Destinationlocator +"is not attached to the page document"+getStackTrace());
				Assert.fail("Element with " + Sourcelocator + "or"+ Destinationlocator +"is not attached to the page document"+getStackTrace());
			}
		  catch (NoSuchElementException e)
			{
				log.error("Element " + Sourcelocator + "or"+ Destinationlocator + " was not found in DOM"+getStackTrace());	
				Assert.fail("Element "+ Sourcelocator + "or"+ Destinationlocator +" was not found in DOM"+getStackTrace());
			}
		  catch(Exception e)
		  {			  		 
			  log.error("Some exception occurred while performing drag and drop operation "+getStackTrace());
			  Assert.fail("Some exception occurred while performing drag and drop operation "+getStackTrace());
		  }
	  }
	...
	public void acceptAlert()
	{
		...
		{			
			...
			Assert.fail("Unable to accept the alert."+getStackTrace());
		}
	}
	...
	public void dismissAlert() throws Exception
	{
		...
		{			
			log.error("Unable to dismiss the alert."+getStackTrace());
			Assert.fail("Unable to accept the alert."+getStackTrace());
		}
	...
	public void safeSelectContextMenuOption(By locator, int iOptionIndex, int waitTime)
	{
		try
	    {
			...
			{
				log.error("Element with locator "+locator+"is not displayed to perform content menu operation"+getStackTrace());
				Assert.fail("Element with locator "+locator+"is not displayed to perform content menu operation"+getStackTrace());
			}
	    }
	    catch(StaleElementReferenceException e)
		{
	    ...
	    {
			log.error("Unable to select context menu option"+getStackTrace());
		   	Assert.fail("Unable to select context menu option"+getStackTrace());
	    }
	}
	...
	public boolean safeEditRichTextEditor(By Framelocator, By TextEditorlocator, String sText, int waitTime) throws Exception
	{
		...
		{
			log.error("Element with " + TextEditorlocator +"is not attached to the page document"+getStackTrace());
			Assert.fail("Element with " + TextEditorlocator +"is not attached to the page document"+getStackTrace());
			return false;
		}
	    catch (NoSuchElementException e)
		{
			log.error("Element " + TextEditorlocator + " was not found in DOM"+getStackTrace());	
			Assert.fail("Element "+ TextEditorlocator +" was not found in DOM"+getStackTrace());
			return false;
		}
		catch(Exception e)	
		{
	...
	public void safeEditTextBoxByTabSequence(String sText, int index) throws Exception 
	{
		...
		{
			log.error("Unable to edit rich text editor."+getStackTrace());
			Assert.fail("Unable to edit rich text editor."+getStackTrace());
		}
	}
	...
	public void uploadFileRobot(By slocator, String sFileLocation, int waitTime)throws Exception
	{
		try
		{
			if(isElementPresent(slocator, waitTime))
			{
				...
				{
					log.error("Unable to click on element with locator" + slocator+" for uploading a file"+getStackTrace());
					Assert.fail("Unable to click on element with locator" + slocator+" for uploading a file"+getStackTrace());
				}
			}
			else
			{
		...
		{
			log.error("Element with " + slocator +"is not attached to the page document"+getStackTrace());
			Assert.fail("Element with " + slocator +"is not attached to the page document"+getStackTrace());			
		}
	    catch (NoSuchElementException e)
		{
			log.error("Element " + slocator + " was not found in DOM"+getStackTrace());	
			Assert.fail("Element "+ slocator +" was not found in DOM"+getStackTrace());			
		}
		catch (Exception e)
		{
	...
	public void safeJavaScriptClick(By locator, int waitTime)
	{
		try
		{
			...
			{
				log.error("Unable to click on element " + locator +getStackTrace());
				Assert.fail("Unable to click on element " + locator +getStackTrace());
			}
		}
		catch(StaleElementReferenceException e)
		{
	...
	public void safeJavaScriptType(By locator,String sText, int waitTime) throws Exception
	{
		try
		{
			...
			{
				log.error("Unable to enter " + sText + " in field " + locator +getStackTrace());
				Assert.fail("Unable to enter " + sText + " in field " + locator +getStackTrace());
			}
		}
		catch(StaleElementReferenceException e)
		{			
	...
	public void scrollIntoElementView(By locator)
	{
		...
		{
			WebElement element = driver.findElement(locator);
			if(ReadInputData.HM_inputData.get("BrowserName").equalsIgnoreCase("ff") 
					|| ReadInputData.HM_inputData.get("BrowserName").equalsIgnoreCase("ie"))
			{
	...
	public String safeJavaScriptGetAttribute(By locator,String sAttributeValue,int waitTime)
	{
		...
		{
			Assert.fail("Unable to get attribute value of type " + sAttributeValue + " from the element "+ locator+getStackTrace());
		}		
		return sValue;		
	} 
	...
	public String safeGetSelectedOptionInDropDown(By locator, int sWaitTime) throws Exception
	{
		...
		try
		{
			...
			{
				log.error("Dropdown with locator: "+locator+" is not displayed"+getStackTrace());
				Assert.fail("Dropdown with locator: "+locator+" is not displayed"+getStackTrace());
			}
		}
		catch(StaleElementReferenceException e)
		{			
		...
		{
 			log.error("Unable to retrieve drop down field value:"+locator+getStackTrace());
 		   	Assert.fail("Unable to retrieve drop down field value:"+locator+getStackTrace());
		}
	...
	public boolean safeVerifyListBoxValue(By locator, String value, int sWaitTime) throws Exception
	{
		...
		{						
			...
			{
				log.error("Listbox with locator: "+locator+" is not displayed"+getStackTrace());
				Assert.fail("Listbox with locator: "+locator+" is not displayed"+getStackTrace());
			}
		...
		{
 			log.error("Unable to verify Listbox value:"+locator+getStackTrace());
 		   	Assert.fail("Unable to verify Listbox value:"+locator+getStackTrace());
		}
		return isExpected;
	}
	...
	public void selectFrame(String frame)
	{
		...
		{
			log.error("Unable to locate frame with id " + frame +getStackTrace());
			Assert.fail("Unable to locate frame with id " + frame +getStackTrace());
		}
		catch(Exception e)
		{
			log.error("Unable to navigate to frame with id " + frame +getStackTrace());
			Assert.fail("Unable to navigate to frame with id " + frame +getStackTrace());
		}
	}
	...
	public void selectFrame(String ParentFrame, String ChildFrame)
	{
		...
		{
			log.error("Unable to locate frame with id " + ParentFrame+" or "+ ChildFrame+getStackTrace());
			Assert.fail("Unable to locate frame with id " + ParentFrame+" or "+ ChildFrame+getStackTrace());
		}
		catch(Exception e)
		{
			log.error("Unable to navigate to innerframe with id " + ChildFrame + "which is present on frame with id" + ParentFrame +getStackTrace());		
			Assert.fail("Unable to navigate to innerframe with id " + ChildFrame + "which is present on frame with id" + ParentFrame +getStackTrace());
		}
	}
	...
	public void selectFrame(By Framelocator, int waitTime)
	{
		try
		{
			...
			else
			{
				...
				Assert.fail("Unable to navigate to frame with locator " + Framelocator +getStackTrace());
			}
		}
		catch(NoSuchFrameException e)
		{
			log.error("Unable to locate frame with locator " + Framelocator+getStackTrace());
			Assert.fail("Unable to locate frame with locator " + Framelocator+getStackTrace());
		}
		catch(Exception e)
		{
			log.error("Unable to navigate to frame with locator " + Framelocator +getStackTrace());
	...
	public void defaultFrame()
	{
		...
		catch(Exception e)
		{
			...
			Assert.fail("unable to navigate back to main webpage from frame"+getStackTrace());
		}
	}
